...
\begin{table}
	...
	\begin{center}
		...
		\begin{tabular}{p{4cm}p{4cm}p{5cm}}
			...
			Multipliers										& 												& All variable replicators\\ % <filebase>-multipliers.json -> analyse_variable_multipliers.py -> <filebase>-variables.json
			\bottomrule
		\end{tabular}
	\end{center}
\end{table}
