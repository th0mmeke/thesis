...
Virgo2013 points out that if goal is increased concentrations, then catalysis not only approach. Stoichiometry can also provide.
Origin in branching chain reactions or autocatalytic sets (both King1978).
...
\begin{itemize}[noitemsep]
	...
	\item Informational replicators based on shortcuts are evolutionarily restricted as their inheritance/heredity mechanism is not evolvable.
\end{itemize} 
