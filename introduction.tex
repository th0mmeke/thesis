...
Ways to recognize open-ended evolution
Causes of open-ended evolution

Theoretical basis for copy mechanism in Part 2

Systems that implement the specific elements we support
Systems that are capable of these elements, but are missing one (the copy mechanism)
