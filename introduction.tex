...
Building on thsis, \textcite{Zachar2010}, extending earlier work by \textcite{Szathmary1999,Szathmary:2006ty}, go on to develop a general classification of replicators as a logical sequence of forms:  
...
\end{enumerate} \parencite[p.21, numbering added for emphasis]{Zachar2010}
...
\begin{table}
	...
	\begin{center}
		...
		\begin{tabular}{@{}p{3cm}p{3cm}p{4cm}p{3cm}@{}}
			\toprule
			Artificial replicator            	& Model form					& Exact$\Leftrightarrow$Variable \parencite{Zachar2010}& Endogenous$\Leftrightarrow$Exogenous replication\\ 
			\midrule
