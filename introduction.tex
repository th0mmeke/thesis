...
The quality of the map was checked by confirming that the search identified previously known papers.
...
Combine all entries, and remove duplicates. After the removal of duplicates, 81 entries remained.
...
\cite{DecraeneMcmullin2011}
\cite{MadinaIkegami2004}
\cite{Hutton2003}
\cite{Kvasnicka2002}
\cite{BedauMcCaskillPackardEtAl2000}
\cite{SuzukiDittrich2009}
\cite{Banzhaf2009}
\cite{BanzhafBaumgaertnerBeslonEtAl2016}
\cite{BanzhafMcMullin2012}
\cite{Bersini2010}
\cite{EibenKernbachHaasdijk2012}
\cite{GarzonBlainBobbaEtAl2003}
\cite{GohEweGoh2013}
\cite{HarrisChen2012}
\cite{Hutton2003a}
\cite{IngerSolomonShenhavEtAl2009}
\cite{KobayashiSuzukiArita2012}
\cite{KvasnickaPospichalKalab2001}
\cite{MadinaOnoIkegami2003}
\cite{MenezesCosta2007}
\cite{SperonidiFenizioDittrich2007}
\cite{Stadler2016}
\cite{SuzukiIkegami2003}
...
At the end of the exercise, our Systematic Map contained 58 papers.
