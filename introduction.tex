...
\subsection{Replicators in evolutionary theory}\cref{replicators-in-evolutionary-theory}
...
Of the forms of replicators defined by \textcite{Zachar2010} and described in \cref{replicators-in-evolutionary-theory}, only full informational replicators provide both the representational range and the evolutionary flexibility for open-ended evolution:
...
None of the artificial systems reviewed in \cref{previous-work} reach the goal of a full informational replicator, but it is apparent that this is a non-trivial objective.
