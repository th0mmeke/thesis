...
Building on this, \citeauthor{Zachar2010}, extending earlier work by \textcite{Szathmary1999,Szathmary:2006ty}, go on to develop a general classification of replicators, shown in \cref{fig:replicators}, as a logical sequence of forms \parencite[p.21, line breaks and numbering added for emphasis]{Zachar2010}:  
...
\begin{figure}[t]
	\begin{center}
		...
		\end{tikzpicture}
		\caption{Replicator systems according to the hierarchy of \citeauthor{Zachar2010}. Diagram redrawn from \cite[Fig.13]{Zachar2010}.}
...
\begin{figure}[t]
	\begin{center}
		...
		\end{tikzpicture}
		\caption{Replicator systems from \cref{previous-work} categorized according to the hierarchy of \citeauthor{Zachar2010}. Diagram redrawn from \cite[Fig.13]{Zachar2010}.}
