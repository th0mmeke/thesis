...
The initiation of selection is marked by the advent of the \gls{ida}, probably from an RNA world, followed substantially later by the so-called \gls{luca} \parencite{Yarus2011}. It is important to note for clarity that \gls{luca} was almost certainly not a single entity or even species, but rather is a construct of evolutionary genetics because of the likely predominance of \gls{hgt} in archaic biology\footnote{http://sandwalk.blogspot.ca/2007/03/web-of-life.html}. Under \gls{hgt}, also known as Lateral Gene Transfer, genetic material is incorporated into an organism's genome by methods other than by vertical transmission by reproduction along the line of descent.
...
\item A new and modular \gls{achem}, ToyWorld (\cref{ch:toyworld}.)
