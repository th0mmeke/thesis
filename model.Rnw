...
library(xtable)
print(xtable(a, caption='ANOVA analysis for H$_1$: $\\overline{fidelity}_{end}$ is proportional to $f(\\Theta,\\sigma_e,\\delta)$', label='tbl:model-mean-anova'), booktabs=TRUE, include.rownames=FALSE, size="scriptsize", caption.placement="top")
@
...
library(xtable)
print(xtable(a, caption='ANOVA analysis for H$_1$: $\\sigma_{fidelity_{end}}$ is proportional to $f(\\Theta,\\sigma_e,\\delta)$', label='tbl:model-sd-anova'), booktabs=TRUE, include.rownames=FALSE, size="scriptsize", caption.placement="top")
@
