...
\subsection{Methods}\label{methods-p2}

The work of \textcite{Bourrat2015} partially addresses our second research question. However, Bourrat as identified in \cref{previous-work-p2}:
\begin{itemize}
...
Addressing these limitations becomes the driver for the work in this \namecref{models-of-inheritance}. The method follows that outlined in \cref{approach}: 
