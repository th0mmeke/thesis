...
It is clear from a visual inspection of \cref{fig:sd-heritability} that we can reject H$_0$ in favour of H$_1$: $\sigma_{heritability_{end}}$ is greater under unpredictable conditions than it is under stable environmental conditions.
