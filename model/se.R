...
names(t2)[1]<-"theta"
names(t2)[2]<-"sd"
for(n in 1:nrow(t1)) {t2[n,'sample_entropy'] <- sample_entropy(unlist(t1[n,3:501],use.names=FALSE))}
for(n in 1:nrow(t1)) {t2[n,'approx_entropy'] <- approx_entropy(unlist(t1[n,3:501],use.names=FALSE))}
