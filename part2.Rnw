...
df <- subset(load.results('results/results-819350e-unrestricted.data'), ecf==0 & distribution==0)
@
...
\begin{table}
	...
	\begin{tabular}{@{}p{2.5cm}p{3cm}p{2cm}p{6cm}@{}}
		...
		\midrule
		$p_{reproduction}$     &$p_{reproduction}$	&4                	& 0.66 or $fitness$\\
		$p_{selection}$        &$p_{selection}$		&4                	& 0.66 or $fitness$\\
		$n_{children}$         &$n_{children}$ 		&2                	& 2 or 5\\
		Reproduction		   &Reproduction		&2				 	& Correlated and Uncorrelated (see \cref{reproduction-distribution-factors})\\
		Distribution           &--					&1                	& Normal distribution ($\mathbb{N}$) (see \cref{reproduction-distribution-factors})\\
		\bottomrule
	\end{tabular}
\end{table}

\begin{table}\label{reproduction-distribution-factors}
	\begin{tabular}{@{}p{2.5cm}p{2.5cm}p{6cm}@{}}
		\toprule
		Reproduction&Child entity parameter					&Distribution\\
		\midrule
		\multirow{2}{*}{Correlated}		&$fitness_{new}$	&$\mathbb{N}, \mu=fitness, \sigma=1-fidelity$\\
										&$fidelity_{new}$	&$\mathbb{N}, \mu=fidelity, \sigma=1-fidelity$\\
		
		\multirow{2}{*}{Uncorrelated}	&$fitness_{new}$	&$\mathbb{N}, \mu=fitness, \sigma=1-fidelity$\\
										&$fidelity_{new}$	&$\mathbb{N}, \mu=fidelity, \sigma=\mathcal{U}[0, 1.0]$\\
		\bottomrule
	\end{tabular}
\end{table}
...
\begin{table}
	...
	\begin{tabular}{@{}p{2.5cm}p{3cm}p{2cm}p{6cm}@{}}
		...
		$n_{children}$         &$n_{children}$ 		&2                	& 2 or 5\\
		Reproduction		   &Reproduction		&2				 	& Correlated and Uncorrelated (see \cref{reproduction-distribution-factors})\\
		Distribution           &--					&2                	& Normal distribution ($\mathbb{N}$) or Uniform distribution ($\mathcal{U}$) (see \cref{reproduction-distribution-factors})\\
		\bottomrule
	\end{tabular}
\end{table}
...
\midrule
\multirow{2}{*}{Correlated}		&$fitness_{new}$	&$\mathbb{N}, \mu=fitness, \sigma=1-fidelity$			&$\mathcal{U}[0, 1.0]$\\
								&$fidelity_{new}$	&$\mathbb{N}, \mu=fidelity, \sigma=1-fidelity$	 		&$\mathcal{U}[0, 1.0]$\\

\multirow{2}{*}{Uncorrelated}	&$fitness_{new}$	&$\mathbb{N}, \mu=fitness, \sigma=1-fidelity$			&$\mathcal{U}[0, 1.0]$\\
								&$fidelity_{new}$	&$\mathbb{N}, \mu=fidelity, \sigma=\mathcal{U}[0, 1.0]$	&$\mathcal{U}[0, 1.0]$\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}
	...
	\begin{tabular}{@{}p{2.5cm}p{3cm}p{2cm}p{6cm}@{}}
		...
		$n_{children}$         &$n_{children}$ 		&2                	& 2 or 5\\
		Reproduction		   &Reproduction		&2				 	& Correlated and Uncorrelated (see \cref{reproduction-distribution-factors})\\
		Distribution           &--					&2                	& Normal distribution_1 or Normal distribution_2\\
		\bottomrule
	\end{tabular}
\end{table}
