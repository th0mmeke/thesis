...
<<unboundedplot, pdfcrop=TRUE, echo=FALSE, cache=TRUE, warning=FALSE, fig.pos='htp', fig.scap=NA, fig.cap='The growth of population size grouped by replicate (that is, by common factor levels) showing rapid population growth before the population size exceeded the specified limit of 50,000 entities.'>>=
...
<<limitcomparisonplots, pdfcrop=TRUE, echo=FALSE, cache=TRUE, fig.pos='htp', fig.scap=NA, fig.cap='Summary plots for fitness-independent sampling ("Independent") and fitness-based or dependent selection ("Dependent"), where the top line contains density plots and the bottom line boxplots showing ranges for both final mean fidelity (on the left-hand side) and final mean fitness (on the right).'>>=
...
<<limitqqplots, pdfcrop=TRUE, echo=FALSE, cache=TRUE, fig.pos='htp', fig.scap=NA, fig.cap='\\Gls{qq} plots comparing fitness-independent and fitness-based or dependent results for fidelity (left) and fitness (right).'>>=
...
\chapter{Sensitivity of the model to parameter values}\label{reducing-the-parameter-space-for-the-experiments}
...
<<p-reproduction, pdfcrop=TRUE, echo=FALSE, cache=TRUE, fig.show='hold',fig.scap=NA, fig.cap='Effect of the factor $p_{reproduction}$ on final mean fidelity ($\\overline{fidelity}_{end}$, on the left) and final mean fitness ($\\overline{fitness}_{end}$, on the right)'>>=
...
<<p-selection, pdfcrop=TRUE, echo=FALSE, cache=TRUE, fig.show='hold',fig.scap=NA, fig.cap='Effect of the factor $p_{selection}$ on final mean fidelity ($\\overline{fidelity}_{end}$, on the left) and final mean fitness ($\\overline{fitness}_{end}$, on the right)'>>=
...
<<n-offspring, pdfcrop=TRUE, echo=FALSE, cache=TRUE, fig.show='hold',fig.scap=NA, fig.cap='Effect of the factor $n_{offspring}$ on final mean fidelity ($\\overline{fidelity}_{end}$, on the left) and final mean fitness ($\\overline{fitness}_{end}$, on the right)'>>=
...
<<n-offspring-population, pdfcrop=TRUE, echo=FALSE, cache=TRUE, fig.pos='htp', fig.scap=NA, fig.cap='Population size over time for two levels of factor $n_{children}$, $n_children=2$ (on the left) and $n_children=5$ (on the right.)'>>=
...
<<example_distributions, pdfcrop=TRUE, echo=FALSE, cache=TRUE, fig.pos='htp', fig.scap=NA, fig.cap='Example showing a normal distribution with mean = 0.5, standard deviation = 0.5 (left), the effect of folding to range $[0,1]$ of the same distribution (centre), and same distribution filtered through the sampling algorithm.'>>=
...
<<normal-normal-uniform, pdfcrop=TRUE, echo=FALSE, cache=TRUE, fig.show='hold',fig.scap=NA, fig.cap='Effect of the factor \\textbf{Reproduction} on final mean fidelity ($\\overline{fidelity}_{end}$, on the left) and final mean fitness ($\\overline{fitness}_{end}$, on the right)'>>=
...
<<correlated-uncorrelated, pdfcrop=TRUE, echo=FALSE, cache=TRUE, fig.pos='htp', fig.scap=NA, fig.cap='Comparison between correlated and uncorrelated levels for the factor \\textbf{Reproduction} showing results for final mean fidelity ($\\overline{fidelity}_{end}$, on the left) and final mean fitness ($\\overline{fitness}_{end}$, on the right)'>>=
...
<<mean-fidelity-fitness, pdfcrop=TRUE, echo=FALSE, cache=TRUE, fig.pos='htp', fig.scap=NA, fig.cap='Ranges by generation of the mean fidelity (top) and mean fitness (bottom) for all levels of all factors. Lines that drop below zero are an artifact of the line smoothing algorithm used (local polynomial regression fitting).'>>=
