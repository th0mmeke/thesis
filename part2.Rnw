...
From \cref{fig:correlated-uncorrelated} it is clear that there is a significant difference for both $\overline{fidelity}_{end}$ and $\overline{fitness}_{end}$ between the two levels of \emph{Reproduction}, as expected.
