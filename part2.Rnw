...
# CORRELATED,N_OFFSPRING,P_REPRODUCE,P_SELECTION,RESTRICTION,ave_cor,ave_fit,environment_mean,environment_sd,experiment,gen,pop,run,sd_cor,sd_fit
load.results.varying <- function(t) {
colClasses <- c("factor","factor","factor","factor","factor","numeric","numeric","numeric","numeric","factor","integer","numeric","integer","numeric","numeric")
read.csv(t, colClasses=colClasses)
}
