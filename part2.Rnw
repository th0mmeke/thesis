...
\begin{algorithm}
	$fitness_{new}\leftarrow$ Distribution with expected value of $fitness$ and variance of $1-fidelity$\;
	$fidelity_{new}\leftarrow$ Distribution with expected value of $fidelity$ and variance of $1-fidelity$\;
\end{algorithm}

\begin{algorithm}
	$fitness_{new}\leftarrow$ Distribution with expected value of $fitness$ and variance $v\in\mathcal{U}[0, 1.0]$\;
	$fidelity_{new}\leftarrow$ Distribution with expected value of $fidelity$ and variance $v\in\mathcal{U}[0, 1.0]$\;
\end{algorithm}
