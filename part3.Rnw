...
A mathematical treatment of \glspl{achem} can be found in \autocite{Benko2009}. \autocite{Dittrich:2001zr} and \autocite{Suzuki2008a} provide excellent reviews of the field, while a full taxonomy is given in \autocite{Dittrich:2001zr}, described in \cref{classification-of-artificial-chemistries}.
