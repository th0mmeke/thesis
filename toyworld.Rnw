...
Artificial Chemistries provide an interesting testbed for investigating various evolutionary phenomena. This \namecref{introduction-to-achems} provides background material to aid in understanding how \glspl{achem} are almost uniquely suited to the exploration of our research questions. We review previous uses of \glspl{achem}, and given the wide range of systems described in previous work, discuss some frameworks for their description and categorisation, which incidentally help in identifying elements common to all \glspl{achem}. Finally we briefly review relevant previous work in applying \glspl{achem} to the problems of \gls{oe} and the origin of life.
