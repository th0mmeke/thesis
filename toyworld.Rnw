...
plot(log(df$Number.of.cycles)~df$Partition.Start, main="Cycle numbers by Partition", ylab="Log number of cycles", xlab="Start of partition")
plot(df$Length.of.longest.cycle~df$Partition.Start, main="Cycle length by Partition", ylab="Length of longest cycle", xlab="Start of partition")
plot(log(df$Count.of.most.common.cycle)~df$Partition.Start, main="Cycle count by Partition", ylab="Log count of most common cycle", xlab="Start of partition")
@
...
par(mfrow=c(1,3),cex=0.4)
boxplot(log(Number.of.cycles)~Product.Strategy, data=df, main="Log cycle numbers by Product Strategy", names=c("Uniform","Energy"), ylab="Number of cycles")
...
boxplot(log(Count.of.most.common.cycle)~Product.Strategy, data=df, main="Log cycle count by Product Strategy",names=c("Uniform","Energy"), ylab="Count of most common cycle")
@
...
par(mfrow=c(1,3),cex=0.4)
boxplot(log(Number.of.cycles)~Reactant.Strategy, data=df, main="Cycle numbers by Reactant Strategy", names=c("Uniform","Kinetic"), ylab="Log number of cycles")
...
boxplot(log(Count.of.most.common.cycle)~Reactant.Strategy, data=df, main="Cycle count by Reactant Strategy",names=c("Uniform","Kinetic"), ylab="Log count of most common cycle")
@
