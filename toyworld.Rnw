...
\subsection{Is there a combination of reactant and product selection strategies that leads to increased emergence as measured by cycles?}
...
\subsection{Is emergence significantly affected by the values of other parameters of an \gls{achem}, such as initial kinetic energy or bond energies?}\label{RQ2.3}
