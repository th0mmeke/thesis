...
Other parameters to the model, such as $E_{Vessel}$, the initial kinetic energy of the molecular population, and $E_{bonds}$, the bonding model, had lesser effects on cycle formation, with the only significant relationship being that of $E_{bonds}$ on the number of cycles produced.