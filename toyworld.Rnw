...
\subsection{RQ2.3: Is emergence significantly affected by the values of other parameters of an \gls{achem}, such as initial kinetic energy or bond energies?}\label{RQ2.3}
