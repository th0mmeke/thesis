...
\section{Conclusions}
In this \namecref{ch:toyworld} we have introduced the ToyWorld \gls{achem}, and explored the effect of four possible combinations of Reactant ($S_\mathrm{Reactant}$) and Product ($S_\mathrm{Product}$) selection strategies on cycle formation.
