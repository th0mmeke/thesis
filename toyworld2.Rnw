...
The experiment design is the same as the design used in \cref{ch:multiplication}, with the addition of factors for the environmental model (factors and levels are given in \cref{tbl:variability-factors}.)
